...
const _presets = [
  ...
  _BoxPreset('아이스 토트백', 45, 30, 35, _PresetCategory.carrier),
  ...
  _BoxPreset('네이처하이크 Star River 2', 45, 15, 15,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('네이처하이크 어메이즈4 (4인)', 55, 20, 20,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('네이처하이크 P시리즈 4P', 48, 18, 18,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('스노우피크 볼트 텐트', 60, 23, 23, _PresetCategory.camping,
  ...
  _BoxPreset('코베아 네스트W (4인 거실형)', 80, 35, 35, _PresetCategory.camping,
      _PresetSubCategory.tent),
  _BoxPreset('코베아 뉴데빌 텐트', 65, 25, 25,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('코베아 파파고 텐트', 60, 22, 22,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('코베아 고스트 팬텀', 72, 30, 30,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('코베아 팝업 텐트 (2-3인)', 90, 9, 90, _PresetCategory.camping,
      _PresetSubCategory.tent),
  _BoxPreset('DOD 원터치 텐트 (3-4인)', 70, 19, 19, _PresetCategory.camping,
      _PresetSubCategory.tent),
  ...
  _BoxPreset('콜맨 코쿤3 (4인 거실형)', 85, 40, 40, _PresetCategory.camping,
      _PresetSubCategory.tent),
  _BoxPreset('콜맨 인스턴트 텐트 4', 97, 46, 24, _PresetCategory.camping,
      _PresetSubCategory.tent),
  _BoxPreset('힐레베르그 아틱', 55, 17, 17,
      _PresetCategory.camping, _PresetSubCategory.tent),
  ...
  // ── 캠핑: 타프 (수납 크기) ──
  // ══════════════════════════════════════
  _BoxPreset('렉타타프 (대형/폴대 포함)', 80, 32, 32, _PresetCategory.camping,
  ...
  _BoxPreset('헬리녹스 택티컬 테이블 M', 41, 12, 11,
      _PresetCategory.camping, _PresetSubCategory.tableChair),
  _BoxPreset('롤테이블 (4인/120cm)', 87, 19, 17, _PresetCategory.camping,
      _PresetSubCategory.tableChair),
  _BoxPreset('접이식 테이블 (2인/60cm)', 60, 45, 5, _PresetCategory.camping,
      _PresetSubCategory.tableChair),
  _BoxPreset('접이식 테이블 (4인/120cm)', 120, 60, 7, _PresetCategory.camping,
      _PresetSubCategory.tableChair),
  ...
  _BoxPreset('헬리녹스 체어원', 35, 12, 12, _PresetCategory.camping,
      _PresetSubCategory.tableChair),
  _BoxPreset('헬리녹스 체어원 라지', 75, 13, 13, _PresetCategory.camping,
      _PresetSubCategory.tableChair),
  ...
  _BoxPreset('네이처하이크 YL06 체어', 50, 13, 13,
      _PresetCategory.camping, _PresetSubCategory.tableChair),
  _BoxPreset('네이처하이크 문체어', 52, 15, 15,
      _PresetCategory.camping, _PresetSubCategory.tableChair),
  _BoxPreset('코베아 이지벤치', 83, 12, 12,
      _PresetCategory.camping, _PresetSubCategory.tableChair),
  _BoxPreset('DOD 바쿠바쿠 의자', 45, 39, 8,
      _PresetCategory.camping, _PresetSubCategory.tableChair),
  ...
  // ── 캠핑: 쿨러/아이스박스 ──
  // ══════════════════════════════════════
  _BoxPreset('스탠리 쿨러 15L', 44, 42, 36, _PresetCategory.camping,
  ...
  _BoxPreset('도메틱 Patrol 20', 53, 36, 38,
      _PresetCategory.camping, _PresetSubCategory.cooler),
  _BoxPreset('콜맨 익스트림 52QT', 70, 38, 44,
      _PresetCategory.camping, _PresetSubCategory.cooler),
  ...
  _BoxPreset('일반 침낭 (3계절)', 43, 20, 20, _PresetCategory.camping,
      _PresetSubCategory.sleepingGear),
  ...
  _BoxPreset('코베아 알파인마스터 2.0', 17, 17, 21, _PresetCategory.camping,
      _PresetSubCategory.cooking),
  _BoxPreset('코베아 3웨이 올인원 L', 56, 36, 11,
  ...
  _BoxPreset('스노우피크 기가파워', 36, 25, 10,
      _PresetCategory.camping, _PresetSubCategory.cooking),
  _BoxPreset('스노우피크 HOME&CAMP 버너', 25, 13, 10,
      _PresetCategory.camping, _PresetSubCategory.cooking),
  _BoxPreset('프리머스 오크누스', 14, 9, 8,
      _PresetCategory.camping, _PresetSubCategory.cooking),
  _BoxPreset('MSR 포켓로켓', 8, 5, 3,
      _PresetCategory.camping, _PresetSubCategory.cooking),
  _BoxPreset('제트보일 플래시', 18, 10, 10,
      _PresetCategory.camping, _PresetSubCategory.cooking),
  _BoxPreset('코펠세트 (2-3인)', 22, 22, 11, _PresetCategory.camping,
      _PresetSubCategory.cooking),
  ...
  _BoxPreset('스노우피크 기어컨테이너', 62, 31, 24,
      _PresetCategory.camping, _PresetSubCategory.storage),
  _BoxPreset('카즈미 트레일 폴딩백', 50, 30, 25,
      _PresetCategory.camping, _PresetSubCategory.storage),
  _BoxPreset('카즈미 크레이트', 60, 40, 28,
      _PresetCategory.camping, _PresetSubCategory.storage),
  _BoxPreset('코베아 3폴딩 컨테이너', 61, 47, 10,
      _PresetCategory.camping, _PresetSubCategory.storage),
  _BoxPreset('폴딩박스 (32L)', 48, 35, 24, _PresetCategory.camping,
      _PresetSubCategory.storage),
  _BoxPreset('폴딩박스 (56L)', 58, 40, 33, _PresetCategory.camping,
      _PresetSubCategory.storage),
  ...
  _BoxPreset('불스원 트렁크 오거나이저', 41, 22, 32,
      _PresetCategory.camping, _PresetSubCategory.storage),
  _BoxPreset('투렁크 트렁크 정리함', 56, 32, 26,
      _PresetCategory.camping, _PresetSubCategory.storage),
  ...
  _BoxPreset('차박 모기장', 45, 15, 15,
      _PresetCategory.camping, _PresetSubCategory.carbivouac),
  _BoxPreset('EcoFlow DELTA 2', 40, 28, 18,
      _PresetCategory.camping, _PresetSubCategory.carbivouac),
  _BoxPreset('EcoFlow DELTA mini', 38, 24, 18,
      _PresetCategory.camping, _PresetSubCategory.carbivouac),
  ...
  _BoxPreset('코베아 파이어캠프2', 44, 30, 10,
      _PresetCategory.camping, _PresetSubCategory.misc),
  _BoxPreset('코베아 워터저그 5L', 24, 24, 26,
      _PresetCategory.camping, _PresetSubCategory.misc),
  _BoxPreset('코베아 워터저그 10L', 35, 16, 35,
      _PresetCategory.camping, _PresetSubCategory.misc),
  _BoxPreset('장작 한 묶음', 40, 25, 20, _PresetCategory.camping,
      _PresetSubCategory.misc),
  ...
  _BoxPreset('캠핑 그라운드시트', 40, 15, 15,
      _PresetCategory.camping, _PresetSubCategory.misc),
  _BoxPreset('캠핑 선풍기 (접이식)', 30, 12, 35,
      _PresetCategory.camping, _PresetSubCategory.misc),
  _BoxPreset('캠핑 히터 (휴대용)', 32, 32, 40,
      _PresetCategory.camping, _PresetSubCategory.misc),
  ...
  // ── 캠핑: 추가 텐트 ──
  _BoxPreset('탈마 미모사 6P (6인)', 88, 35, 30,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('제큐아 돔텐트 3-4인', 60, 20, 20,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('콜맨 다크룸 6P', 92, 42, 28,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('로벤스 프리즘 텐트', 62, 26, 26,
      _PresetCategory.camping, _PresetSubCategory.tent),
  _BoxPreset('반고 오메가 450 (4인)', 72, 32, 26,
      _PresetCategory.camping, _PresetSubCategory.tent),
  ...
  // ── 추가 쿨러 ──
  _BoxPreset('코베아 아이스박스 30L', 52, 33, 35,
      _PresetCategory.camping, _PresetSubCategory.cooler),
  _BoxPreset('다이소 소프트 쿨러백', 35, 22, 28,
      _PresetCategory.camping, _PresetSubCategory.cooler),
  ...
  // ── 추가 차박 ──
  _BoxPreset('차량용 냉장고 (15L)', 35, 28, 30,
      _PresetCategory.camping, _PresetSubCategory.carbivouac),
  _BoxPreset('차량용 냉장고 (25L)', 45, 35, 38,
      _PresetCategory.camping, _PresetSubCategory.carbivouac),
  ...
  _BoxPreset('Helinox 코트 원 컨버터블', 55, 16, 16,
      _PresetCategory.camping, _PresetSubCategory.tableChair),
  _BoxPreset('캠핑 세면도구 파우치', 25, 15, 12,
      _PresetCategory.camping, _PresetSubCategory.storage),
  _BoxPreset('캠핑 구급함', 25, 18, 10,
      _PresetCategory.camping, _PresetSubCategory.misc),
  _BoxPreset('Kovea 파워 스토브 (접이)', 20, 20, 10,
      _PresetCategory.camping, _PresetSubCategory.cooking),
