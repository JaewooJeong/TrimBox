...
| 차종 | 폭 | 깊이 | 높이 | 비고 |
|------|----|------|------|------|
| 쏘렌토 5인승 | 1.08 | 1.10 | 0.78 | 추정치 (근거: `trunk_space.dart` 주석) |
| 쏘렌토 7인승·3열 접음 | 1.08 | 1.18 | 0.77 | 추정치 |
...
- `test/models/auto_layout_test.dart` 감사에서 찾은 회귀 + 4차종 무작위 800회 물리 유효성(충돌 0·부양 0)
